...
GIT_DST = https://github.com/euclidpoint/euclidpoint.github.io
...
ghmirror: site
	...
	echo Mirror of EuclidPoint.com >> $(README)
	echo ========================= >> $(README)
	echo >> $(README)
	echo Generated from [euclidpoint/euclidpoint.com][GIT_SRC] >> $(README)
